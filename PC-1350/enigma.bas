...
' For SHARP PC-1350/1360/2500 by Robert van Engelen
...
' DEF-SPACE: start over, return to menu
...
310 " " GOSUB 1000: CURSOR 0: PRINT "A)plugs","D)start","B)rotors","X)text/code","C)rings"
320 CURSOR 60: INPUT A$: GOTO CHR$(ASC A$ AND 95)
...
680 W=0, T$(0)="": INPUT T$(0)
690 IF T$(0)="" PRINT "END": END
...
970 NEXT N
980 PRINT: IF P LPRINT ""
990 GOTO 680

' display header and footer
1000 CLS: WAIT 0: PRINT "+++ WEHRMACHT ENIGMA +++": CURSOR 72: PRINT "DEFA DEFB DEFC DEFD DEFX": CURSOR 24: RETURN
